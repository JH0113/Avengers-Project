			...
			<div class="container">
				...
				<div class="regist_box">
					...
					<span class="input_box"> 
						<input type="text" name="postNumber" id="sample4_postcode" readonly="readonly" class="input">
						<input type="button" class="localbtn" value="주소검색" onclick="avascript:sample4_execDaumPostcode()"/>
					</span>
