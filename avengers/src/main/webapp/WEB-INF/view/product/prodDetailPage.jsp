               ...
               <tr class="border_bottom">
                  ...
                  <div class="slider">
                         ...
                         <ul id="imgholder" class="imgs">
                             <li><img src="upload/${productdto.prodImage }" width="500" height="500"></li>
                             <li><img src="upload/${productdto.prodImage2 }" width="500" height="500"></li>
                             <li><img src="upload/${productdto.prodImage3 }" width="500" height="500"></li>
                         </ul>
                         <div class="bullets">
