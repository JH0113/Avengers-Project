...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=5921de72df8da90539ae4441abbd63ca&libraries=services"></script>
<script>
//마커를 담을 배열입니다
var markers = [];
...
var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
    mapOption = {
        center: new kakao.maps.LatLng(37.50237036730535, 127.02430119627044), // 지도의 중심좌표
        level: 3 // 지도의 확대 레벨
    };  
